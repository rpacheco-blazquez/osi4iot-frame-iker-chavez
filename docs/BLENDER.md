...
2. **Ir a Preferences**:
   ...
   <img src="media/Blender_edit_preferences.png" width="70%" style="display: block; margin: 0 auto;">
   
3. **Navegar a Add-ons**:
   - Clic en la pestaña "Add-ons" en el panel izquierdo

   <img src="media/Blender_addons.png" width="70%" style="display: block; margin: 0 auto;">
   
4. **Instalar Addon**:
   - Clic en "Install..." en la parte superior derecha.

   <img src="media/Blender_install.png" width="70%" style="display: block; margin: 0 auto;">

   - Navegar a la ubicación del archivo `load_fem_meshes.py`
   - Seleccionar el archivo y hacer clic en "Install Add-on"

   <img src="media/Blender_install_addon.png" width="70%" style="display: block; margin: 0 auto;">
...
5. **Activar el Addon**:
   ...
   <img src="media/Blender_addon_activate.png" width="70%" style="display: block; margin: 0 auto;">

#### Paso 3: Importar malla FEM a Blender
1. **Ir a `Object > Load FEM meshes`**

   <img src="media/Blender_object_loadfemmeshes.png" width="70%" style="display: block; margin: 0 auto;">
...
3. Hacer clic en **`Load FEM meshes`** para importar la malla.
   ...
   <img src="media/Blender_load_mesh.png" width="70%" style="display: block; margin: 0 auto;">
